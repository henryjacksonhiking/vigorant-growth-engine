...
const cards = [
  { icon: Brain, color: "hsl(248 93% 71%)", title: "AI Search Monitoring",
  ...
  { icon: Sparkles, color: "hsl(188 100% 62%)", title: "Generative Engine Optimization (GEO)",
    ...
    <Section bg="secondary">
      ...
      <Reveal delay={0.2} className="max-w-4xl mx-auto mt-10">
        <div className="rounded-2xl px-10 py-8 text-center"
          style={{
            background: "linear-gradient(135deg, hsl(188 100% 62% / 0.06), hsl(248 93% 71% / 0.08))",
            border: "1px solid hsl(188 100% 62% / 0.25)",
          }}>
  ...
  return (
    <Reveal delay={delay}>
      <div ref={ref}
        ...
        style={{ border: "1px solid hsl(248 93% 71% / 0.12)" }}>
