      ...
      <div ref={tiltRef}
        ...
        <div className="flex items-start justify-between mb-5">
          ...
          <div className="flex items-center gap-1.5 font-mono-ui text-[11px] text-brand-purple">
            <span className="w-1.5 h-1.5 rounded-full bg-brand-purple pulse-dot" /> Live
          </div>
        </div>
        ...
        <div className="border-t border-black/[0.06] pt-4 space-y-3">
          ...
          <Row delay={2500} bg="bg-[hsl(248_100%_75%/0.14)]" emoji="💬" label="Reactivated Patients" sub="Dormant list win-back" value="+112" tone="text-[hsl(248_100%_60%)]" />
