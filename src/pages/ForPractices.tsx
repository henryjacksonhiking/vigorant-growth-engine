...
function ForPracticesSeo() {
  ...
  return (
    <Helmet>
      ...
      <meta name="description" content="Vigorant helps dental, medical, and chiropractic practices boost visibility, ROI, and lead conversion with AI-driven marketing." />
