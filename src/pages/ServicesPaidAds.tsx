...
const FAQS = [
  ...
  { q: "What ad platforms do you manage?", a: "Google Search, Performance Max, YouTube, Meta (Facebook + Instagram), and retargeting. Channel mix is decided by service line, geography, and competitive landscape — not vendor preference." },
